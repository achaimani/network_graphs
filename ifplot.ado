...
// bug corrected resulting in wrong IFs when changing reference 
...
program ifplot
	...
	qui{
		...
		encode `t1',gen(`told1') lab(_ttrt)
		encode `t2',gen(`told2') lab(_ttrt)
		gen `tnew1'=min(`told1',`told2')
		gen `tnew2'=max(`told1',`told2')
		replace `y'=-`y' if `tnew1'==`told1'
