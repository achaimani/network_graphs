...
{p 4 4 2}
You can get the latest version of this package from {stata "net from https://www.cer-methods.com/Stata"}. To run the commands the latest versions of {helpb metan}, {helpb metareg} and {helpb mvmeta} or {helpb network} are required.
...
{phang}{cmd:. use "https://www.cer-methods.com/Stata/antidiabetics_efficacy_wide.dta", clear}{p_end}
{phang}  {stata "use https://www.cer-methods.com/Stata/antidiabetics_efficacy_wide.dta, clear":(click to run)}{p_end}
...
{phang}{cmd:. use "https://www.cer-methods.com/Stata/antiplatelet.dta", clear}{p_end}
{phang}  {stata "use https://www.cer-methods.com/Stata/antiplatelet.dta, clear":(click to run)}{p_end}
...
{phang}{cmd:. use "https://www.cer-methods.com/Stata/antihypertensives.dta", clear}{p_end}
{phang}  {stata "use https://www.cer-methods.com/Stata/antihypertensives.dta, clear":(click to run)}{p_end}
...
{phang}{cmd:. use "https://www.cer-methods.com/Stata/antidiabetics_efficacy_long.dta", clear}{p_end}
{phang}  {stata "use https://www.cer-methods.com/Stata/antidiabetics_efficacy_long.dta, clear":(click to run)}{p_end}
...
{phang}{cmd:. use "https://www.cer-methods.com/Stata/antidiabetics_tolerability.dta", clear}{p_end}
{phang}  {stata "use https://www.cer-methods.com/Stata/antidiabetics_tolerability.dta, clear":(click to run)}{p_end}
{phang}{cmd:. network setup y sd n, stud(id) trt(t) ref(1) num}{p_end}
{phang}  {stata "network setup y sd n, stud(id) trt(t) ref(1) num":(click to run)}{p_end}
{phang}{cmd:. network meta c}{p_end}
{phang}  {stata "network meta c":(click to run)}{p_end}
...
{phang}{cmd:. use "https://www.cer-methods.com/Stata/antidiabeticsSUCRAS.dta", clear}{p_end}
{phang}  {stata "use https://www.cer-methods.com/Stata/antidiabeticsSUCRAS.dta, clear":(click to run)}{p_end}
...
{p 4 4 2}
Anna Chaimani, University of Ioannina School of Medicine, email: {browse "mailto:anna.chaimani@inserm.fr":anna.chaimani@inserm.fr}
